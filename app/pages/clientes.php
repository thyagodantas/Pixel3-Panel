...
<body>
    ...
    <div class="content">
        ...
        <div class="box-content left w100">
            ...
            <h2><i class="fa-regular fa-user-tag"></i> Cadastrar clientes</h2>
            ...
            <div class="overview-content-clientes">
                ...
                <form class="clientes-form" method="post" enctype="multipart/form-data">
                    <input type="text" name="nome" id="nome" placeholder="Nome do site do cliente">
                    <input type="file" name="imagem" id="imagem" placeholder="Link da logo do cliente">
                    <input type="text" name="url" id="url" placeholder="Link do site do cliente">
                    <input type="hidden" name="clientes" value="clientes">
                    <input type="submit" value="Publicar cliente">
                </form>
        ...
        <div class="box-content left w100">
            <h2><i class="fa-regular fa-list"></i> Clientes cadastrados</h2>
            <div class="table-content">
                <table>
                    ...
                    $porPagina = 4;
                    $resultados = ClientesModel::listClients(($PaginaAtual - 1) * $porPagina, $porPagina * $PaginaAtual);
                    foreach ($resultados as $resultado) {
                    ?>
                        <tr>
                            <td><?php echo $resultado['nome']; ?></td>
                            <td><?php echo $resultado['url']; ?></td>
                            <td>
                                <form method="post">
            ...
            <div class="paginacao">
                ...
                $totalPaginas = ceil(count(ClientesModel::listClients()) / $porPagina);
